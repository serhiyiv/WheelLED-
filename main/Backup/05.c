...
volatile unsigned long int MEMORY_POS = 0;
volatile unsigned long int IMAGE_SIZE = 12288;
volatile unsigned long int SETTINGS_POS = 0;
...
volatile unsigned long int ImageIDX = 0;
...
volatile unsigned long int SETTINGS_IMAGES_COUNT = 1;
...
void Hall_Action (void)
{
	...
	{
		NextImage = 0;
		volatile unsigned long int TempImageIDX = ImageIDX;		
	...
	volatile  unsigned long int TTT = Ticks + 1;	
	AngleTime = TTT / 359;
...
{
	volatile unsigned long int   NextImageIDX ;
	volatile unsigned long int  TempNextImageIDX = ImageIDX + 1;
