...
{
	TicksImageTime++;
	if (TicksImageTime >=  90000) // Time in seconts * 1000ms /   Time resolution = number of ticks   3000ms/0.05 = 60000 ticks = 3seconds
	{
		NextImage = 1;
		TicksImageTime =0;
