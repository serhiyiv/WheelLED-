...
#define L74HC595_SERPIN PC0
#define L74HC595_SRCLKPIN PC2
#define L74HC595_RCLKPIN PC1
//setup number of chip attached to the board
#define L74HC595_ICNUMBER 24
...
extern void l74hc595_setregallon(uint8_t Shift);
extern void l74hc595_setregalloff(uint8_t Shift);
